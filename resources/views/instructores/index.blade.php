...
<a href="{{url('instructores/create')}}">+</a>
<table>
    <thead>
        <th>usuario</th>
        <th>centro</th>
    ...
    <tbody>
        @foreach ($instructores as $instructor)
            <tr>
                ...
                <td>
                    <form action="{{url('aprendices/'.$instructor->IdInstructor)}}">
                ...
                <td>
                    <form action="{{url('aprendices/'.$instructor->IdInstructor.'/edit')}}">
                ...
                <td>
                    <form method="post" action="{{url('aprendices/'.$instructor->IdInstructor)}}">
                        @method('DELETE')
                        @csrf
